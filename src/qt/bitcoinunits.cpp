...
{
    switch (unit) {
    case Unit::BTC: return QString("QRN");
    case Unit::mBTC: return QString("mQRN");
    case Unit::uBTC: return QString::fromUtf8("µQRN (bits)");
    case Unit::SAT: return QString("Quranium (ium)");
...
QString BitcoinUnits::shortName(Unit unit)
{
    ...
    case Unit::SAT: return QString("ium");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
{
    switch (unit) {
    case Unit::BTC: return QString("Quranium");
    case Unit::mBTC: return QString("Milli-Quranium (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Quranium (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("Quranium (ium) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
