    ...
    tab(_tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your Quranium addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ui->deleteAddress->setVisible(true);
        ui->newAddress->setVisible(true);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Quranium addresses for receiving payments. Use the 'Create new receiving address' button in the receive tab to create new addresses.\nSigning is only possible with addresses of the type 'legacy'."));
...
void AddressBookPage::on_exportButton_clicked()
{
    ...
    if(!writer.write()) {
        QMessageBox::critical(this, tr("Exporting Failed"),
            ...
            tr("There was an error trying to save the address list to Quranium. Please try again.").arg(filename));
    }
}
