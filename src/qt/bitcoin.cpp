...
void BitcoinApplication::handleRunawayException(const QString &message)
{
    QMessageBox::critical(
        ...
        tr("A fatal error occurred. Quranium Core can no longer continue safely and will quit.").arg(PACKAGE_NAME) +
...
void BitcoinApplication::handleNonFatalException(const QString& message)
{
    ...
    QMessageBox::warning(
        ...
        tr("An internal error occurred. Quranium Core will attempt to continue safely. This is "
...
#if defined(Q_OS_WIN)
            WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("Quranium core didn't yet exit safely…").arg(PACKAGE_NAME), (HWND)app.getMainWinId());
#endif
            app.exec();
        } else {
