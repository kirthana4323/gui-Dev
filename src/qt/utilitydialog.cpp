    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        setWindowTitle(tr("About Quranium Core").arg(PACKAGE_NAME));
        ...
        QString header = "Usage: bitcoin-qt [command-line options] [URI]\n\n"
                         "Optional URI is a Quranium address in BIP21 URI format.\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Quranium Core is shutting down…").arg(PACKAGE_NAME) + "<br /><br />" +
