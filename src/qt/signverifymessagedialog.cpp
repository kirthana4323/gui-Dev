...
void SignVerifyMessageDialog::on_signMessageButton_SM_clicked()
{
    ...
    if (!pkhash) {
        ...
        ui->statusLabel_SM->setStyleSheet("QLabel { color: red; }");
        ui->statusLabel_SM->setText(tr("The entered address does not refer to a legacy key. Please check the address and try again.").arg(PACKAGE_NAME));
        return;
    }
...
void SignVerifyMessageDialog::on_verifyMessageButton_VM_clicked()
{
    ...
    case MessageVerificationResult::ERR_ADDRESS_NO_KEY:
        ...
        ui->statusLabel_VM->setText(tr("The entered address does not refer to a legacy (P2PKH) key. Message signing is not supported in this version of Quranium Core. Please check the address and try again.").arg(PACKAGE_NAME));
        return;
